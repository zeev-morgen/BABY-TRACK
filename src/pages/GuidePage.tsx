    ...
    <div>
      ...
      <div className="card">
        <ul className="tips">
          ...
          <li>אפשר לצרף לכל חודש תמונה והקלטה קצרה. {COPY.storageShort}.</li>
          {cloud ? (
            <li>
              אפשר לשתף את היומן עם ההורה השני — שניכם כותבים לאותו יומן, כל אחד מהמכשיר שלו. הכל במסך{' '}
              <Link to="/share">שיתוף</Link>.
            </li>
          ) : null}
          <li>
      ...
      <div className="card">
        ...
        <ul className="tips">
          <li>
            <strong>באייפון כדאי להוסיף למסך הבית:</strong> כפתור השיתוף ⬆️ בתחתית Safari → "הוספה למסך הבית".
            {cloud
              ? ' היומן נפתח במסך מלא, עם אייקון משלו, כמו אפליקציה רגילה.'
              : ' זה לא רק נוח — Safari מנקה נתונים של אתרים שלא נכנסים אליהם כשבוע, ואפליקציה שנוספה למסך הבית לא נכללת בניקוי.'}
          </li>
          <li>
